//
//  NotificationColumnInspectorView.swift
//
//
...
struct NotificationColumnInspectorView: View {

    @Binding var columnCustomization: TableColumnCustomization<NotificationHistoryItem>
    @Binding var columnOrder: NotificationColumnOrder
    ...
    private func showAllColumns() {
        for columnID in NotificationColumnID.allCases {
    ...
    private func resetColumnOrder() {
        columnOrder.columns = Array(NotificationColumnID.allCases)
    }
}

private struct NotificationColumnToggleRow: View {
    let columnID: NotificationColumnID
    @Binding var columnCustomization: TableColumnCustomization<NotificationHistoryItem>
